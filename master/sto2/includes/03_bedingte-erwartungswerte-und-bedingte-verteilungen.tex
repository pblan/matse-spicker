...
\begin{defi}[Filtration]{Natürliche Filtration}
    ...
    \[
        \mathcal{F}_{t}:=\sigma ({X_{s}({\mathcal{A}});s\leq t})
    \]
...
\begin{example}[Value at Risk]{Value at Risk für normalverteilte Zufallsvariablen}
...
\begin{example}[Value at Risk]{Value at Risk für eine Summe normalverteilter Zufallsvariablen}
    % https://de.wikipedia.org/wiki/Value_at_Risk#Beispiele
