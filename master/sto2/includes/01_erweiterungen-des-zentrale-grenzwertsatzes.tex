...
\begin{defi}{Schema von Zufallsvariablen}
    ...
    Ein Schema von Zufallsvariablen heißt \emph{unabhängig}, wenn für alle $n\in \mathbb {N}$ die Zufallsvariablen $(X_{n,l})_{l=1,\dots ,k_{n}}$ stochastisch unabhängig sind.

    Ein Schema von Zufallsvariablen heißt \emph{zentriert}, wenn  wenn $\operatorname {E} (X_{n,l})=0$ ist für alle $n,l$.

    Ein Schema von Zufallsvariablen heißt \emph{normiert}, wenn für alle $n\in \mathbb {N}$ gilt, dass
    \[
    ...
    \[
        \lim _{n\to \infty }\max _{1\leq l\leq k_{n}}P(|X_{n,l}|>\varepsilon )=0 \quad \text{für alle} \quad \varepsilon >0.
    \]
\end{defi}
...
\begin{defi}[Lindeberg-Bedingung]{Formulierung für Schemata von Zufallsvariablen}
    ...
    TODO: Besser über eine normalisierte Variable gehen.
