...
\begin{defi}{Markow-Hedging}
    % https://www.math.uni-frankfurt.de/~ismi/kuehn/continuous_time.pdf
    Eine \emph{Markow-Hedging-Strategie} ist eine Hedging-Strategie, die nur vom aktuellen Preis des Basiswertes abhängt.
...
\begin{defi}[Momentanzinsmodell]{Zinsstrukturgleichung}
    ...
    Unter dieser Annahme ist die Short-Rate ein Markow-Prozess und es gilt für den Preis einer Nullkuponanleihe
    \[
