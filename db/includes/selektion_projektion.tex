...
\begin{sql}{SELECT}
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_all.txt}
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_projektion.txt}
...
\begin{sql}{WHERE}
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_where.txt}
\end{sql}
...
SELECT * FROM pokemon ORDER BY Name ASC;
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_order_by_name.txt}
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_order_by_typ.txt}
\end{sql}
...
FROM pokemon
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_concat.txt}
\end{sql}
...
FROM pokemon;
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_round.txt}
\end{sql}
...
SELECT COUNT(PrimaerTyp) FROM pokemon;
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_count_all.txt}
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_count.txt}
\end{sql}
...
FROM pokemon
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_null.txt}
\end{sql}
...
SELECT COALESCE(NULL, NULL, ..., NULL, 'Ausgabe') AS 'Beispiel';
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_coalesce_ausgabe.txt}
...
FROM entwicklung;
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_coalesce.txt}
\end{sql}
...
\begin{sql}{DISTINCT}
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_distinct_all.txt}
    ...
    \lstinputlisting[style=BashOutputStyle]{includes/code/out_sql_select_distinct.txt}
\end{sql}
