...
\begin{defi}{Permutation}
    ...
    \[
        P(n) = n \cdot (n-1) \cdot (n-2) \cdot \ldots \cdot 1 = n!
    \]
...
\begin{defi}{Gleichverteilung}
    ...
    \begin{itemize}
        \item Erwartungswert: $\mu = \frac{a + b}{2}$
        \item Varianz: $\sigma^2 = \frac{(b - a)^2}{12}$
        \item Standardabweichung: $\sigma = \sqrt{\sigma^2} = \frac{b-a}{\sqrt{12}}$
    \end{itemize}
\end{defi}
...
\begin{algo}{Transformation auf standardisierte Variable}
    ...
    \begin{itemize}
        ...
        \item $P(a \leq X \leq b) = \Phi \left( \frac{a - \mu}{\sigma} \right) - \Phi \left( \frac{b - \mu}{\sigma} \right)$
        \item $\Phi(-u) = 1 - \Phi(u)$
    \end{itemize}
\end{algo}
